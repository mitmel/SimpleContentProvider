...
public class ContentResolverTestUtils {
    ...
    public static Cursor testQuery(ContentResolver cr, Uri uri, String[] projection,
            String selection, String[] selectionArgs, String sortOrder, int expectedCount) {
        ...
        if (expectedCount == 0) {
            ProviderTestCase2.assertFalse("expected moveToFirst to signal an empty cursor",
                    c.moveToFirst());
        } else {
    ...
    public static final String[] TEST_RAND = new String[] { "foo", "bar", "baz", "fnord" };
    ...
    public static <A extends ContentProvider> void testBulkInsert(ProviderTestCase2<A> tc,
            Uri dest, String field, ContentValues cvExtra) {
